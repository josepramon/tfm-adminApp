...
###
Status module edit controller
===============================

Controller responsible for Statuses editing
...
module.exports = class EditController extends ViewController
  ...
  getModel: (id, originalCollection) ->
    model = @appChannel.request 'tickets:statuses:entity', id
    ...
    @appChannel.request 'form:component', view,
      ...
      onFormDelete:  ->
        if window.confirm(i18n.t 'Are you sure you want to delete this?')
          statusesChannel.trigger 'delete:tickets:status', model
  ...
  formActionDone: (success = false) ->
    if success
      flashMessage = i18n.t 'tickets:::Status successfully updated'

...
module.exports = class TicketsCategoriesApp extends Module
  ...
  meta:
    ...
    ###
    title: -> i18n.t 'modules::TicketsUncategorised'

    ###
    @property {String} root url for all module routes
    ###
    rootUrl: 'tickets/uncategorised'
